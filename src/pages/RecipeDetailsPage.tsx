            ...
            >
              <img
                ...
                className={`aspect-square w-full rounded-xl border border-slate-200 shadow-sm ${
                  photoUrl === DEFAULT_RECIPE_IMAGE_URL ? 'p-[10px]' : ''
                } ${
                ...
                <div className="mt-2 flex items-center justify-between gap-2">
                  ...
                  {canUseTried && (
                    <button
                      ...
                      className={`instant-tooltip inline-flex h-12 w-12 items-center justify-center rounded-full border-2 shadow-md transition-colors ${
                        isRecipeTried
                      ...
                      type="button"
                    >
                      <svg aria-hidden="true" className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="mt-2 flex items-center justify-between gap-2">
              ...
              {canUseTried && (
                <button
                  aria-label={t('triedRecipe')}
                  aria-pressed={isRecipeTried}
                  className={`instant-tooltip inline-flex h-10 w-10 items-center justify-center rounded-full border-2 shadow-md transition-colors ${
                    isRecipeTried
                      ? 'border-emerald-800 bg-emerald-100 text-emerald-800'
                      : 'border-emerald-600 bg-white text-emerald-700 hover:bg-emerald-50'
                  }`}
