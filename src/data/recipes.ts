...
export const recipes: Recipe[] = [
  ...
  {
    id: 'krem-karamel-chox2',
    title: 'Крем карамел',
    description: 'Класически домашен крем карамел с яйца, прясно мляко, ванилия и златист карамел.',
    prepMinutes: 55,
    servings: 6,
    complexity: 'medium',
    dishType: 'dessert',
    cuisine: 'bulgarian',
    mainProducts: ['plodove'],
    ingredients: [
      '1 л прясно мляко',
      '6 яйца',
      '180 г захар',
    ...
    steps: [
      'Карамелизирай 100 г захар на среден огън и разпредели в купички или тава.',
      'Разбий яйцата с останалата захар, ванилията и щипка сол.',
      'Затопли млякото и го добави на тънка струя към яйчената смес, като разбъркваш.',
      'Прецеди сместа и я разпредели върху карамела.',
      'Печи на водна баня около 40-45 минути на 160°C до леко стягане.',
  ...
  {
    id: 'bobena-salata-chox2',
    title: 'Бобена салата',
    description: 'Свежа бобена салата с червен лук, печени чушки и магданоз.',
    prepMinutes: 20,
    servings: 4,
    complexity: 'easy',
    dishType: 'salad',
    ...
    steps: [
      'Измий добре сварения боб и го отцеди.',
      'Нарежи лука на тънки полумесеци и чушките на ленти.',
      'Смеси боба, лука и чушките в купа.',
      'Овкуси със зехтин, оцет, сол и черен пипер.',
