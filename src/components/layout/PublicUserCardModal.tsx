                ...
                <div className="mt-2">
                  {!isMessageComposerOpen ? (
                    <button
                      ...
                      className={`instant-tooltip rounded-md px-3 py-1.5 text-xs font-medium transition-colors ${
                        canSendMessage
                      ...
                      data-tooltip={canSendMessage ? t('sendAuthorMessage') : t('registeredRequiredTooltip')}
                    >
                      {t('sendAuthorMessage')}
                    </button>
                  ) : (
