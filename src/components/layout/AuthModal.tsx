...
const SHOW_GOOGLE_LOGIN_OPTION = true;
const SHOW_APPLE_LOGIN_OPTION = false;
const SHOW_FACEBOOK_LOGIN_OPTION = false;
const SHOW_GITHUB_LOGIN_OPTION = false;
